#!/usr/bin/env bash
#
# blueberry :: Phase 4 repo protection and merge policy
#
...
readonly OWNER="${BLUEBERRY_OWNER:-Great-Grand-Software}"
readonly REPO="${BLUEBERRY_REPO:-blueberry}"
readonly BRANCH="${BLUEBERRY_BRANCH:-main}"
